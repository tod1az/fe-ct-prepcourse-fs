...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   objetoProducto.calcularPrecioDescuento = function(){
      let descuento   =objetoProducto.porcentajeDeDescuento*objetoProducto.precio
      let precioFinal = objetoProducto.precio-descuento;
      return precioFinal
   }
   return objetoProducto
}
console.log(agregarMetodoCalculoDescuento({precio:10,porcentajeDeDescuento:0.2}).calcularPrecioDescuento)
